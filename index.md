...
{% include figure.html img="centeno_headshot.jpg" {: style="float: left"} alt="Headshot of Raquel Centeno" width="75%" 
  height="75%"%}
...
{% include figure.html img="xochi_lay_down.jpeg" alt="Photo of Xochi, Raquel Centeno's cat" caption="Xochi (pronounced so-chee), the cat I spend my time with." width="100%" height="50%" %}
